  ...
  <div class="progress" >
    ...
    progress-bar-animated bg-success" role ="progressbar" :style="{'width': porcentaje +'%'} "
...
<option  >app movil con react native</option>
  ...
  <script>
    ...
    this.completado=false;
        ...
        Cambiar(S){ //va en mayusculas
    
     this.proyectos[S].completado = !this.proyectos[S].completado; //te falto
  }
      },
      computed:{
        numeroProyectos(){
